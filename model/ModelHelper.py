...
class ModelHelper:
    ...
    def experiment(self, epochs, optimizer, train_loader, valid_loader, trainingMetrics, validationMetrics,
                   decisionToSaveModel=None, fileToSaveModel=None, parametersToSave={}):
        best_acc = 0
