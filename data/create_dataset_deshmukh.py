...
if __name__ == '__main__':
    ...
    bugPerId, masterSet, masterByBugId, mastersetByMasterId = getMasterSetAndDuplicateByMaster(args.database,
                                                                                               args.collection)
    ...
    trainDuplicatePairs, testDuplicatePairs = train_test_split(duplicatePairs, test_size=args.test_size,
                                                               random_state=randomSeed)
    trainSplitDuplicatePairs, validationDuplicatePairs = train_test_split(trainDuplicatePairs,
